...
### Types of Tests
* Static Testing - linters, etc.
* Unit Tests - Testing the smallest pieces of our code (functions)
* Integration Tests - Multiple piece of the app working together
see: https://twitter.com/timbray/status/822470746773409794
* End-to-End Test (e2e) - testing the app as a user would
* Benchmarking: How long does it take to <do X>?
* Load Testing: https://jmeter.apache.org/usermanual/get-started.html
...
- [Jest](https://jestjs.io/)
  * The Jest test runner (and expectation library) is the framework we use to run our tests
